...
public class DatabaseManager {
        ...
        throws SQLException
    {
        ...
        // Migrations
        try {
            _database.execSQL(_applicationContext.getString(org.robbojunior.android.R.string.sql_add_gift));
        ...
        extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(_context.getString(org.robbojunior.android.R.string.sql_create_projects));
            Log.i(LOG_TAG, "Created table projects");

            db.execSQL(_context.getString(org.robbojunior.android.R.string.sql_create_usershapes));
            Log.i(LOG_TAG, "Created table usershapes");

            db.execSQL(_context.getString(org.robbojunior.android.R.string.sql_create_userbkgs));
            Log.i(LOG_TAG, "Created table userbkgs");

            db.execSQL(_context.getString(org.robbojunior.android.R.string.sql_add_gift));
